...
# Function to perform whitespace-insensitive replacement
function Replace-Normalized($html, $from, $to) {
    # Replace any sequence of whitespace in $from with placeholder
