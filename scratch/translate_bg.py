...
file_path = r"c:\Users\Usuario\Downloads\diabetes-book-main (1)\diabetes-book-main\diabetesbulgaro\index.html"
...
content = content.replace('src="assets/product-img.png"\n                        alt="The Easiest Diabetic Diet After 60 – product image"', 'src="assets/product-img.png"\n                        alt="Най-лесната диета при диабет след 60 – изображение на продукта"')
...
content = content.replace('If you are tired of complex meal plans, bland food, and constantly guessing what is “safe” to eat, this bundle is for you. The Easiest Diabetic Diet After 60 is a clear, practical, and science-backed guide designed specifically for older adults who want to control their blood sugar, protect their heart, and boost their energy – without giving up the foods they love. Instant digital download – these are e-books (After payment is completed, you will immediately have the option to download the product(s) from the final purchase page, and you will also receive a download email shortly after).', 'Ако сте уморени от сложни хранителни планове, безвкусна храна и постоянно отгатване какво е „безопасно“ за ядене, този пакет е за вас. „Най-лесната диета при диабет след 60“ е ясно, практично и научно обосновано ръководство, създадено специално за по-възрастни хора, които искат да контролират кръвната си захар, да предпазят сърцето си и да повишат енергията си – без да се отказват от храните, които обичат. Незабавно цифрово изтегляне – това са електронни книги (След завършване на плащането веднага ще имате възможност да изтеглите продукта(ите) от крайната страница за покупка, а малко след това ще получите и имейл за изтегляне).')
...
print("Translation to Bulgarian complete!")
